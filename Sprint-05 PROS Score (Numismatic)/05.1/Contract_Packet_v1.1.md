...
**Scope:** UX contract, math contract, link contract, EMA & price store semantics, non‑negotiables only  
**Exclusions:** No implementation, debugging, planning, placement decisions, stability judgments, or inferred rules  
