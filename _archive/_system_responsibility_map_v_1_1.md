# System Responsibility Map (SRM) — v1.1
...
## Clarification (Classifier Consolidation)

A **single classifier / gate engine module** may be used.

This is a wording clarification only and introduces **no behavioral change**.

### Classifier / Gate Engine (single module)
**Owns:**
- Eligibility determination (**INELIGIBLE vs eligible**)
- **HIT / PROS / MISS** decision logic (per Contract Packet)
- **Diagnostic bucketing and counts** (development-only; non-UX)

**Must never:**
- Alter console or email UX
- Perform EMA capture or modify EMA eligibility
- Override Melt HIT with PROS
- Compute payout math or format output
...
**Owns:**
- Applying the classifier’s decision in the runtime pipeline
- Orchestration and control flow only

**Must never:**
- Decide classification rules
- Reformat UX strings
...
- Apply business rules (HIT / PROS / eligibility)
...
**Owns:**
- Eligibility (eligible vs INELIGIBLE)
- HIT / PROS / MISS decisions (per Contract Packet)
- Diagnostic classification counts (development-only)
