# Contract_Packet_v1.0

**Status:** Immutable once approved
**Scope:** UX contract, math contract, link contract, non‑negotiables only
**Exclusions:** No implementation, debugging, planning, or inferred rules
